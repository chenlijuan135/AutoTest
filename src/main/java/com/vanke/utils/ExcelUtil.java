...
public class ExcelUtil {
    ...
    public static void writeExcel(OutputStream os) throws IOException, WriteException {
    ...
    public static void readExcel(File file) throws IOException, BiffException, ParseException {
